<nav class="sb-topnav navbar navbar-expand navbar-info bg-info shadow-sm">
    <button class="btn btn-link btn-sm" id="sidebarToggle" href="#">
        <i class="fas fa-bars fa-fw font-weight-bold text-white"></i>
    </button>
    <a class="navbar-brand order-lg-first text-sm-center font-weight-bold" style="color:white;" href="<?= base_url(); ?>">LAS BERKAH JAYA</a>
    <!-- Navbar-->
